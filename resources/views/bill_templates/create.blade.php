@extends('layouts.app')
@section('title', 'Create Bill Template')
@section('page-title', 'Create Bill Template')
@section('page-subtitle', 'Predefine products and services for 1-click billing')
...
<div class="max-w-5xl mx-auto" x-data="templateApp()">
    ...
    <form action="{{ route('bill-templates.store') }}" method="POST" id="template-form">
        @csrf
