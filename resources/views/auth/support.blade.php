            ...
            <div class="w-full slide-up" style="animation-delay: 0.1s;">
                ...
                <div class="space-y-6">
                    ...
                    <div class="p-6 bg-slate-50 border border-slate-200 rounded-2xl flex items-start gap-4">
                        ...
                        <div class="min-w-0 flex-1">
                            <span class="inline-block text-[10px] font-bold text-emerald-600 bg-emerald-100 px-2 py-0.5 rounded-full mb-1">Administration</span>
                            <h4 class="text-base font-bold text-slate-800">Super Admin</h4>
                            <p class="text-sm text-slate-500 mt-1 font-medium">Email: <span class="text-slate-700 font-bold select-all">superadmin@suhaimsoft.com</span></p>
                        </div>
                    </div>
