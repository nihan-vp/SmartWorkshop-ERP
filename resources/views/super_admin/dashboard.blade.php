...
<div x-show="activeTab === 'dashboard'" class="space-y-5 animate-fade-in-up" x-cloak>
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="stat-card relative rounded-2xl p-5 overflow-hidden" style="background: linear-gradient(135deg, #fff7ed, #ffedd5); border: 1px solid #fdba74;">
            ...
            <table class="w-full text-sm">
                <thead style="background: #f8fafc;">
                    <tr>
                        ...
                        <th class="text-center text-[10px] font-bold text-slate-400 uppercase tracking-wider px-5 py-3">Staff</th>
