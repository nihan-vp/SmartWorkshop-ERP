...
<header>
    <div class="container header-inner">
        <!-- Logo -->
        <a href="#" class="logo">
            <img src="{{ asset('icons/icon.svg') }}" alt="Suhaim Soft" style="width: 38px; height: 38px; border-radius: 10px;">
...
<footer>
    <div class="container">
        <div class="footer-top">
            <div>
                <a href="#" class="brand">
                    <img src="{{ asset('icons/icon.svg') }}" alt="Suhaim Soft" style="width: 28px; height: 28px; border-radius: 6px;">
