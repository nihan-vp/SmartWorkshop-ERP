        ...
        <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-5 mb-5">
                    ...
                    <div>
                        ...
                        <select name="priority" class="form-select" required>
                            <option value="normal" {{ old('priority', $workOrder->priority) === 'normal' ? 'selected' : '' }}>Normal</option>
            ...
            <div class="pt-6 border-t border-white/10">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-5">
                    ...
                    <div><label class="form-label">Start Date</label><input type="date" name="start_date" value="{{ old('start_date', $workOrder->start_date ? $workOrder->start_date->format('Y-m-d') : '') }}" class="form-input"></div>
                    <div><label class="form-label">End Date</label><input type="date" name="end_date" value="{{ old('end_date', $workOrder->end_date ? $workOrder->end_date->format('Y-m-d') : '') }}" class="form-input"></div>
                </div>
            </div>
        </div>
