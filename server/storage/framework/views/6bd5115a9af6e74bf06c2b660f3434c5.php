...
<?php $__env->startSection('page-subtitle', 'Record a new purchase from a supplier'); ?>
...
<div class="max-w-3xl animate-fade-in-up">
    ...
    <form action="<?php echo e(route('purchases.store')); ?>" method="POST" class="glass-card shadow-sm p-6 sm:p-8 relative overflow-hidden">
        <?php echo csrf_field(); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 relative z-10">
            <div class="space-y-1 md:col-span-2">
                ...
                <input type="text" name="supplier_name" id="supplier_name" value="<?php echo e(old('supplier_name')); ?>" required class="form-input" placeholder="e.g. ABC Auto Parts">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="space-y-1">
                ...
                <input type="text" name="invoice_number" id="invoice_number" value="<?php echo e(old('invoice_number')); ?>" class="form-input" placeholder="e.g. INV-2023-001">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="space-y-1">
                ...
                <input type="date" name="purchase_date" id="purchase_date" value="<?php echo e(old('purchase_date', date('Y-m-d'))); ?>" required class="form-input">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="space-y-1">
                ...
                <input type="number" step="0.01" min="0" name="total_amount" id="total_amount" value="<?php echo e(old('total_amount')); ?>" required class="form-input font-mono" placeholder="0.00">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="space-y-1 md:col-span-2">
                ...
                <textarea name="items_description" id="items_description" rows="3" class="form-input" placeholder="e.g. 5x Engine Oil, 10x Brake Pads..."><?php echo e(old('items_description')); ?></textarea>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Suhaim Soft Work Shop\suhaimsoftworkshop\server\resources\views\purchases\create.blade.php ENDPATH**/ ?>