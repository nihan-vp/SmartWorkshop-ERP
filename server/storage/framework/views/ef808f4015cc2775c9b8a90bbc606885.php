...
<?php $__env->startSection('title', 'Products & Stock'); ?>
<?php $__env->startSection('page-title', 'Products & Stock'); ?>
<?php $__env->startSection('page-subtitle', 'Manage your inventory'); ?>
...
<div x-data="{ 
    ...
    openCreate() {
        ...
        this.actionUrl = '<?php echo e(route('products.store')); ?>';
        this.methodOverride = '';
    ...
    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
        <form method="GET" class="flex items-center gap-2 w-full sm:w-auto">
            <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Search products..." class="form-input sm:w-72">
    ...
    <div class="glass-card !p-0 overflow-hidden">
        <div class="overflow-x-auto">
            <table class="data-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td data-label="Sl No" class="text-slate-400 font-semibold"><?php echo e(($products->currentPage() - 1) * $products->perPage() + $loop->iteration); ?></td>
                        <td data-label="Name" class="font-bold text-slate-800"><?php echo e($p->name); ?></td>
                        <td data-label="Barcode" class="font-mono text-xs font-semibold text-slate-500"><?php echo e($p->barcode ?? '—'); ?></td>
                        <td data-label="Category" class="font-medium text-slate-600"><?php echo e($p->category ?? '—'); ?></td>
                        <td data-label="Price" class="text-emerald-600 font-bold">₹<?php echo e(number_format($p->price, 2)); ?></td>
                        <td data-label="Cost" class="font-medium text-slate-600">₹<?php echo e(number_format($p->cost_price, 2)); ?></td>
                        <td data-label="Stock" class="font-bold <?php echo e($p->isLowStock() ? 'text-red-600' : 'text-slate-800'); ?>"><?php echo e($p->stock_qty); ?> <?php echo e($p->unit); ?></td>
                        <td data-label="Min" class="font-medium text-slate-600"><?php echo e($p->min_stock); ?></td>
                        ...
                        <td data-label="">
                            <div class="flex items-center gap-2">
                                <button @click="openEdit({ 
                                    ...
                                    barcode: '<?php echo e(addslashes($p->barcode ?? '')); ?>', 
                                    category: '<?php echo e(addslashes($p->category ?? '')); ?>', 
                                    price: '<?php echo e($p->price); ?>', 
                                    cost_price: '<?php echo e($p->cost_price); ?>', 
                                    stock_qty: '<?php echo e($p->stock_qty); ?>', 
                                    min_stock: '<?php echo e($p->min_stock); ?>', 
                                    unit: '<?php echo e(addslashes($p->unit)); ?>'
                                })" class="text-amber-600 hover:text-amber-700 transition-colors" title="Edit">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
                                </button>
                                <form action="<?php echo e(route('products.destroy', $p)); ?>" method="POST" onsubmit="return confirm('Delete product <?php echo e($p->name); ?>?')">
        ...
        <div class="px-5 py-4 border-t border-slate-200/60"><?php echo e($products->appends(request()->query())->links()); ?></div>
        <?php endif; ?>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Suhaim Soft Work Shop\suhaimsoftworkshop\server\resources\views\products\index.blade.php ENDPATH**/ ?>