...
<body class="bg-slate-50 flex items-center justify-center min-h-screen p-4 sm:p-6 md:p-8">
    ...
    <div class="w-full max-w-md bg-white rounded-2xl shadow-sm border border-slate-200 p-6 sm:p-8">
        ...
        <a href="<?php echo e(url('/')); ?>" class="inline-flex items-center gap-1.5 text-slate-500 hover:text-blue-600 text-sm font-semibold transition-colors mb-6">
        ...
        <form action="<?php echo e(route('login.post')); ?>" method="POST" class="space-y-4 sm:space-y-5" x-data="{ loading: false, showToast: false }" @submit="if(!navigator.onLine) { $event.preventDefault(); showToast = true; setTimeout(() => showToast = false, 3000); return; } loading = true; setTimeout(() => loading = false, 2000)">
            <?php echo csrf_field(); ?>
            ...
            <div>
                <label class="block text-sm font-semibold text-slate-700 mb-1">
                    <span class="inline-flex items-center gap-1.5">
                        <svg width="14" height="14" class="w-3.5 h-3.5 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="relative">
                    <svg width="16" height="16" class="w-4 h-4 text-slate-400 absolute left-3 top-1/2 -translate-y-1/2 pointer-events-none" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                    </svg>
                    <input type="email" name="email" required placeholder="admin@example.com" value="<?php echo e(old('email')); ?>"
...
$message = $__bag->first($__errorArgs[0]); ?><p class="text-xs text-red-500 mt-1 flex items-center gap-1">
                    <svg width="12" height="12" class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/></svg>
                    <?php echo e($message); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div x-data="{ show: false }">
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-1 sm:gap-0 mb-1">
                    ...
                    <a href="<?php echo e(route('support')); ?>" class="text-xs font-semibold text-blue-600 hover:text-blue-800 hover:underline">
                        Forgot password?
                    </a>
                </div>
                <div class="relative">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                <button type="submit" :disabled="loading"
                    ...
                    <svg width="16" height="16" x-show="loading" class="w-4 h-4 animate-spin" fill="none" viewBox="0 0 24 24" style="display: none;">
            ...
            <div x-show="showToast" 
                 ...
                 style="display: none;">
                <svg width="20" height="20" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/></svg>
        ...
        <div class="mt-5 sm:mt-6 text-center text-sm text-slate-600 flex flex-col sm:flex-row items-center justify-center gap-1 sm:gap-1.5">
            ...
            <a href="<?php echo e(route('register')); ?>" class="text-blue-600 font-semibold hover:underline">Register your garage</a>
        </div>
...
<?php /**PATH E:\Suhaim Soft Work Shop\suhaimsoftworkshop\server\resources\views/auth/login.blade.php ENDPATH**/ ?>