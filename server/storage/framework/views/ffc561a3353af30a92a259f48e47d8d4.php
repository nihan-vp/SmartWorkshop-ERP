...
<div class="max-w-2xl mx-auto"><div class="glass-card">
    <form action="<?php echo e(route('products.update', $product)); ?>" method="POST">
        ...
        <div class="space-y-5">
            ...
            <div><label class="form-label">Category</label><input type="text" name="category" value="<?php echo e(old("category", $product->category)); ?>" placeholder="Enter category" class="form-input"></div>
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-5">
                <div><label class="form-label">Stock Qty *</label><input type="number" name="stock_qty" value="<?php echo e(old("stock_qty", $product->stock_qty)); ?>" placeholder="Enter stock qty" class="form-input" required></div>
                <div><label class="form-label">Min Stock *</label><input type="number" name="min_stock" value="<?php echo e(old("min_stock", $product->min_stock)); ?>" placeholder="Enter min stock" class="form-input" required></div>
                <div><label class="form-label">Unit *</label><input type="text" name="unit" value="<?php echo e(old("unit", $product->unit)); ?>" placeholder="Enter unit" class="form-input" required></div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Suhaim Soft Work Shop\suhaimsoftworkshop\server\resources\views\products\edit.blade.php ENDPATH**/ ?>