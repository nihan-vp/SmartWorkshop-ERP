...
<?php $__env->startSection('title', 'Create Bill Template'); ?>
<?php $__env->startSection('page-title', 'Create Bill Template'); ?>
<?php $__env->startSection('page-subtitle', 'Predefine products and services for 1-click billing'); ?>
...
<div class="max-w-5xl mx-auto" x-data="templateApp()">
    ...
    <form action="<?php echo e(route('bill-templates.store')); ?>" method="POST" id="template-form">
        <?php echo csrf_field(); ?>
                ...
                <div class="glass-card">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="name" required placeholder="e.g. Premium General Servicing Package" class="form-input">
                        </div>
                        <div>
                            <label class="form-label">Description</label>
                            <textarea name="description" rows="2" placeholder="Brief details about what this package includes..." class="form-input"></textarea>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Suhaim Soft Work Shop\suhaimsoftworkshop\server\resources\views\bill_templates\create.blade.php ENDPATH**/ ?>