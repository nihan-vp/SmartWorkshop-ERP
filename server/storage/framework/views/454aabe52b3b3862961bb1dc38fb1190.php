...
<?php $__env->startSection('page-subtitle', 'Manage workshop expenses'); ?>
...
<div class="glass-card !p-0 overflow-hidden mt-6">
    ...
    <div class="bg-white border-b border-slate-200/60">
        ...
        <div class="flex items-center justify-between px-5 py-4 border-b border-slate-100">
            ...
            <a href="<?php echo e(route('expenses.create')); ?>" class="btn-primary px-4 py-2 text-sm">
        ...
        <form method="GET" id="expenseFilter" class="px-5 py-3.5 flex flex-wrap items-end gap-3">
            ...
            <div class="flex-1 min-w-[160px]">
                ...
                <div class="relative">
                    ...
                    <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Search description..." class="form-input pl-9 py-2 text-sm w-full">
                </div>
            </div>
            ...
            <div class="flex items-center gap-2 shrink-0">
                ...
                <a href="<?php echo e(route('expenses.index')); ?>" class="btn-secondary py-2 px-4 text-sm">
    ...
    <div class="overflow-x-auto">
        <table class="data-table">
            ...
            <tbody>
                ...
                <tr>
                    <td data-label="Sl No" class="text-slate-400 font-semibold"><?php echo e(($expenses->currentPage() - 1) * $expenses->perPage() + $loop->iteration); ?></td>
                    <td data-label="Date" class="font-medium text-slate-600"><?php echo e($expense->expense_date->format('d M Y')); ?></td>
                    <td data-label="Category" class="font-bold text-slate-800"><?php echo e($expense->category); ?></td>
                    <td data-label="Description" class="text-slate-600 font-medium"><?php echo e(Str::limit($expense->description ?? '—', 30)); ?></td>
                    <td data-label="Amount" class="text-rose-600 font-bold">-₹<?php echo e(number_format($expense->amount, 2)); ?></td>
                    <td data-label="Payment"><span class="badge <?php echo e($expense->payment_method === 'upi' ? 'badge-info' : 'badge-warning'); ?>"><?php echo e(strtoupper($expense->payment_method)); ?></span></td>
                    <td data-label="">
                        <div class="flex items-center gap-2">
                            <a href="<?php echo e(route('expenses.edit', $expense)); ?>" class="text-amber-600 hover:text-amber-700" title="Edit"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg></a>
                            <form action="<?php echo e(route('expenses.destroy', $expense)); ?>" method="POST" onsubmit="return confirm('Delete expense record for <?php echo e($expense->category); ?>?')"><?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?><button class="text-red-500 hover:text-red-600" title="Delete"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/></svg></button></form>
                        </div>
                    </td>
                </tr>
    ...
    <?php if($expenses->hasPages()): ?><div class="px-5 py-4 border-t border-slate-100"><?php echo e($expenses->appends(request()->query())->links()); ?></div><?php endif; ?>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Suhaim Soft Work Shop\suhaimsoftworkshop\server\resources\views\expenses\index.blade.php ENDPATH**/ ?>