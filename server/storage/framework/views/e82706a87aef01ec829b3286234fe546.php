...
<header>
    <div class="container header-inner">
        ...
        <div class="header-actions">
            ...
            <a href="<?php echo e(route('register')); ?>" class="btn-primary" style="padding: 0.55rem 1.25rem; font-size: 0.85rem;">
                Get Started
            </a>
    ...
    <div class="mobile-nav" id="mobile-nav">
        ...
        <a href="<?php echo e(route('register')); ?>" style="color: #2563eb;">Get Started →</a>
    </div>
</header>
...
<footer>
    <div class="container">
        <div class="footer-top">
            ...
            <div>
                ...
                <ul>
                    ...
                    <li><a href="<?php echo e(route('register')); ?>">Start Free Trial</a></li>
        ...
        <div class="footer-bottom">
            <p>© <?php echo e(date('Y')); ?> Suhaim Soft Work Shop. All rights reserved.</p>
        </div>
    </div>
</footer>
...
<?php /**PATH E:\Suhaim Soft Work Shop\suhaimsoftworkshop\server\resources\views\welcome.blade.php ENDPATH**/ ?>