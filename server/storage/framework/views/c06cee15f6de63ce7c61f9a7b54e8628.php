...
<?php $__env->startSection('page-subtitle', 'Manage your customer database'); ?>
...
<div x-data="{ 
    ...
    openCreate() {
        ...
        this.actionUrl = '<?php echo e(route('customers.store')); ?>';
        this.methodOverride = '';
    ...
    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
        <form method="GET" class="flex items-center gap-2 w-full sm:w-auto">
            <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Search customers..." class="form-input sm:w-72" id="search-customers">
        <button type="submit" class="btn-secondary whitespace-nowrap px-4 py-2">
            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/></svg> Search
        </button>
        </form>
    ...
    <div class="glass-card !p-0 overflow-hidden">
        <div class="overflow-x-auto">
            <table class="data-table" id="customers-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td data-label="Sl No" class="text-slate-400 font-semibold"><?php echo e(($customers->currentPage() - 1) * $customers->perPage() + $loop->iteration); ?></td>
                        <td data-label="Name" class="font-bold text-slate-800"><?php echo e($customer->name); ?></td>
                        <td data-label="Phone" class="font-medium text-slate-600"><?php echo e($customer->phone ?? '—'); ?></td>
                        <td data-label="Email" class="font-medium text-slate-600"><?php echo e($customer->email ?? '—'); ?></td>
                        <td data-label="Vehicles"><span class="badge badge-info"><?php echo e($customer->vehicles_count); ?></span></td>
                        <td data-label="Bills"><span class="badge badge-purple"><?php echo e($customer->bills_count); ?></span></td>
                        <td data-label="">
                            <div class="flex items-center gap-2">
                                <button @click="openView({ 
                                    id: <?php echo e($customer->id); ?>, 
                                    name: '<?php echo e(addslashes($customer->name)); ?>', 
                                    phone: '<?php echo e(addslashes($customer->phone ?? '')); ?>', 
                                    email: '<?php echo e(addslashes($customer->email ?? '')); ?>', 
                                    address: '<?php echo e(addslashes($customer->address ?? '')); ?>',
                                    vehicles_count: <?php echo e($customer->vehicles_count); ?>,
                                    bills_count: <?php echo e($customer->bills_count); ?>
                                ...
                                <form action="<?php echo e(route('customers.destroy', $customer)); ?>" method="POST" onsubmit="return confirm('Delete customer <?php echo e($customer->name); ?>?')">
        ...
        <div class="px-5 py-4 border-t border-slate-200/60"><?php echo e($customers->appends(request()->query())->links()); ?></div>
        <?php endif; ?>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Suhaim Soft Work Shop\suhaimsoftworkshop\server\resources\views\customers\index.blade.php ENDPATH**/ ?>