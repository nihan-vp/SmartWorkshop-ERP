...
@section('page-subtitle', 'Record a new purchase from a supplier')
...
<div class="max-w-3xl animate-fade-in-up">
    ...
    <form action="{{ route('purchases.store') }}" method="POST" class="glass-card shadow-sm p-6 sm:p-8 relative overflow-hidden">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 relative z-10">
            <div class="space-y-1 md:col-span-2">
                ...
                <input type="text" name="supplier_name" id="supplier_name" value="{{ old('supplier_name') }}" required class="form-input" placeholder="e.g. ABC Auto Parts">
                @error('supplier_name') <p class="form-error">{{ $message }}</p> @enderror
            </div>

            <div class="space-y-1">
                <label for="invoice_number" class="form-label">Invoice Number</label>
                <input type="text" name="invoice_number" id="invoice_number" value="{{ old('invoice_number') }}" class="form-input" placeholder="e.g. INV-2023-001">
            ...
            <div class="space-y-1">
                ...
                <input type="date" name="purchase_date" id="purchase_date" value="{{ old('purchase_date', date('Y-m-d')) }}" required class="form-input">
            ...
            <div class="space-y-1">
                ...
                <input type="number" step="0.01" min="0" name="total_amount" id="total_amount" value="{{ old('total_amount') }}" required class="form-input font-mono" placeholder="0.00">
            ...
            <div class="space-y-1 md:col-span-2">
                ...
                <textarea name="items_description" id="items_description" rows="3" class="form-input" placeholder="e.g. 5x Engine Oil, 10x Brake Pads...">{{ old('items_description') }}</textarea>
